...
const TaskComp = ({
 ...
 <Day>
     ...
     <ButtonCont>
     <PtsButton className="opensans">10 <br/><Span>Points</Span></PtsButton>
     <PtsButton className="opensans">Tues</PtsButton>
     <PtsButton className="opensans">Wed</PtsButton>
     <PtsButton className="opensans">Thurs</PtsButton>
     <PtsButton className="opensans">Fri</PtsButton>
     <PtsButton className="opensans">Sat</PtsButton>
     <PtsButton className="opensans">Sun</PtsButton>
